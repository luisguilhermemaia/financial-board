...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/board/boardModule.js',
			'app/modules/board/boardCtrl.js',
			'app/modules/board/boardRoute.js',
			'app/modules/board/boardService.js',
			'app/modules/board/board-test.js',
			'app/modules/board/office.model.js',
		],
